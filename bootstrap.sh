...
echo "  2. Instalar el binario 'reposynapse' en tu PATH"
echo "     (npm i -g reposynapse)"
echo "  3. Atlassian Rovo / Google Drive: se activan automáticamente al hacer"
echo "     login con tu cuenta Claude.ai. No requieren configuración local."
echo "  4. Plugins (context7, skill-creator, warp): se descargan al primer uso."
